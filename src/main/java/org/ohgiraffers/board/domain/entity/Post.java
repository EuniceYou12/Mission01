 ...
 * 주의
 * 데이터의 일관성을 위해 setter 사용을지양해야 한다.
 * setter를 사용한다면, 어디에서든 Entity를 수정해버릴 수 있기 때문에 일관성을 유지하기 어렵다.
 */

/*
 * @Data -> getter, setter, toString, equalsandhasgcode..
 */

//@Entity: JAP Entity라는 것을 의미한다. Id와 @GeneratedValue를 이용해 고유 식별자를 정의한다.
@Entity
...
@AllArgsConstructor
//@NoAllArgsConstructor : 매개변수가 없는 기본 생성자를 생성한다.
